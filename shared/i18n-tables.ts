...
const valueTranslations: Record<string, string> = {
  ...
  "Word, PowerPoint, PDF, video, and other prepared lesson materials": "Word, PowerPoint, PDF, видео болон бусад бэлдсэн хичээлийн материалууд"
};
...
export const translations = {
  en: {
    ...
    common: {
      ...
      noTimetableMatchSearch: "No timetable slots match your search.",
      searchGrades: "Search grades...",
      noGradesMatchSearch: "No grades match your search.",
      searchAttendance: "Search attendance...",
      noAttendanceMatchSearch: "No attendance records match your search.",
      searchAnnouncements: "Search announcements...",
      noAnnouncementsMatchSearch: "No announcements match your search.",
      todayIsAQuietDay: "Today is a quiet day",
    ...
    subjectContent: {
      ...
      sections: {
        file: { title: "Add from file", subtitle: "Upload a prepared lesson file or photo" },
        topic: { title: "Add topic", subtitle: "Create a new topic with a title and description" },
        lesson: { title: "Add lesson", subtitle: "Create a text-based lesson inside a topic" },
        video: { title: "Add video lesson", subtitle: "Attach a video link to a topic" },
        assignment: { title: "Add assignment", subtitle: "Create a new assignment" }
      },
      chooseFile: "Choose file or photo",
      filePickerHint: "Upload an image or file",
      filesSelected: (n: number) => `${n} file${n === 1 ? "" : "s"} selected`,
      lessonTitlePlaceholder: "Lesson title",
      topicTitlePlaceholder: "Topic title",
      topicDescriptionPlaceholder: "Description",
      selectTopic: "Select a topic",
      durationPlaceholder: "Duration",
      objectivesPlaceholder: "Objectives (one per line)",
      videoUrlPlaceholder: "Video link (YouTube, Vimeo, etc.)",
      assignmentTitlePlaceholder: "Assignment title",
      assignmentDescriptionPlaceholder: "Description",
      dueDatePlaceholder: "Due date (YYYY-MM-DD)",
      maxScorePlaceholder: "Max score",
      assignmentTypePlaceholder: "Select type",
      assignmentTypeOptions: { homework: "Homework", quiz: "Quiz", project: "Project", practice: "Practice", other: "Other" },
      upload: "Upload",
      addTopicAction: "Add topic",
      addLessonAction: "Add lesson",
      addVideoLessonAction: "Add video lesson",
      addAssignmentAction: "Add assignment",
      needsTopicFirst: "Add at least one topic first.",
      ...
      videoLessonAdded: "Video lesson added",
  ...
  mn: {
    ...
    common: {
      ...
      noSubjectsYet: "Одоогоор хичээл алга байна.",
      searchSubjects: "Хичээл хайх...",
      noSubjectsMatchSearch: "Хайлтад тохирох хичээл олдсонгүй.",
      searchTimetable: "Хуваарь хайх...",
      noTimetableMatchSearch: "Хайлтад тохирох хуваарь олдсонгүй.",
      searchGrades: "Дүн хайх...",
      noGradesMatchSearch: "Хайлтад тохирох дүн олдсонгүй.",
      searchAttendance: "Ирц хайх...",
      noAttendanceMatchSearch: "Хайлтад тохирох ирц олдсонгүй.",
      searchAnnouncements: "Зарлал хайх...",
      noAnnouncementsMatchSearch: "Хайлтад тохирох зарлал олдсонгүй.",
      todayIsAQuietDay: "Өнөөдөр амгалан өдөр байна",
    ...
    subjectContent: {
      ...
      sections: {
        file: { title: "Файлаас нэмэх", subtitle: "Бэлтгэсэн хичээлийн файл эсвэл зураг оруулах" },
        topic: { title: "Сэдэв нэмэх", subtitle: "Гарчиг, тайлбартай шинэ сэдэв үүсгэх" },
        lesson: { title: "Хичээл нэмэх", subtitle: "Сэдвийн дотор бичвэр хичээл үүсгэх" },
        video: { title: "Видео хичээл нэмэх", subtitle: "Сэдэвт видео холбоос хавсаргах" },
        assignment: { title: "Даалгавар нэмэх", subtitle: "Шинэ даалгавар үүсгэх" }
      },
      chooseFile: "Файл эсвэл зураг сонгох",
      filePickerHint: "Зураг эсвэл файл оруулах",
      filesSelected: (n: number) => `${n} файл сонгогдлоо`,
      lessonTitlePlaceholder: "Хичээлийн нэр",
      topicTitlePlaceholder: "Сэдвийн нэр",
      topicDescriptionPlaceholder: "Тайлбар",
      selectTopic: "Сэдэв сонгох",
      durationPlaceholder: "Үргэлжлэх хугацаа",
      objectivesPlaceholder: "Зорилго (мөр бүрт нэг)",
      videoUrlPlaceholder: "Видео холбоос (YouTube, Vimeo г.м)",
      assignmentTitlePlaceholder: "Даалгаврын нэр",
      assignmentDescriptionPlaceholder: "Тайлбар",
      dueDatePlaceholder: "Хугацаа (YYYY-MM-DD)",
      maxScorePlaceholder: "Дээд оноо",
      assignmentTypePlaceholder: "Төрөл сонгох",
      assignmentTypeOptions: { homework: "Гэрийн даалгавар", quiz: "Шалгалт", project: "Төсөл", practice: "Дасгал", other: "Бусад" },
      upload: "Оруулах",
      addTopicAction: "Сэдэв нэмэх",
      addLessonAction: "Хичээл нэмэх",
      addVideoLessonAction: "Видео хичээл нэмэх",
      addAssignmentAction: "Даалгавар нэмэх",
      needsTopicFirst: "Эхлээд дор хаяж нэг сэдэв нэмнэ үү.",
      chooseFileFirst: "Файл сонгоно уу.",
      fillRequiredFields: "Шаардлагатай талбаруудыг бөглөнө үү.",
      fileAdded: "Файл нэмэгдлээ",
      topicAdded: "Сэдэв нэмэгдлээ",
      lessonAdded: "Хичээл нэмэгдлээ",
      videoLessonAdded: "Видео хичээл нэмэгдлээ",
